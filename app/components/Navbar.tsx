...
export default function Navbar({ onOpenAuth, onOpenWhatsApp }: NavbarProps) {
            ...
            {user ? (
              <div className="flex items-center gap-3">
                ...
                <div className="relative">
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/[0.03] border border-white/5 hover:bg-white/5 transition-colors"
                  >
                  ...
                  {dropdownOpen && (
                    <div className="absolute right-0 top-12 w-56 bg-[#0f0f1a] border border-white/10 rounded-xl p-2 shadow-2xl">
                      ...
                      <button
                        ...
                        className="w-full text-left px-3 py-2 rounded-lg text-sm text-green-400 hover:bg-white/5 transition-colors flex items-center gap-2"
                      >
                      ...
                      <button
                        ...
                        className="w-full text-left px-3 py-2 rounded-lg text-sm text-red-400 hover:bg-white/5 transition-colors flex items-center gap-2"
                      >
                        <LogOut size={16} />
                        Sign Out
                      </button>
              ...
              <>
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-violet-600 to-blue-600 text-sm font-medium px-5 py-2.5 rounded-xl text-white hover:shadow-lg hover:shadow-violet-500/20 transition-all"
                >
                  Get Started
                </button>
              </>
        ...
        <div className="md:hidden bg-[#0f0f1a] border-t border-white/5 px-4 py-4 space-y-3">
          ...
          {user ? (
            <button
              ...
              className="w-full text-left text-sm text-green-400 flex items-center gap-2 py-2"
            >
            ...
            <button
              ...
              className="w-full text-left text-sm text-violet-400 py-2"
            >
              Get Started
            </button>
          )}
