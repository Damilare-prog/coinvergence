      ...
      <div className="relative w-full max-w-lg bg-[#0f0f1a] border border-white/10 rounded-2xl p-8 shadow-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-gray-400">
            Tell us what you want to trade. We&apos;ll connect you on WhatsApp instantly.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {assetType === "crypto" && (
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white focus:border-green-500 focus:outline-none transition-all"
              >
                {["Bitcoin (BTC)", "Ethereum (ETH)", "Solana (SOL)", "USDT (TRC20)", "Other — specify in notes"].map(
                  (c) => (
          ...
          {assetType === "giftcard" && (
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white focus:border-green-500 focus:outline-none transition-all"
              >
                {["Amazon", "Apple", "Google Play", "Steam", "Visa Prepaid", "Other — specify in notes"].map(
                  (g) => (
          ...
          {assetType === "domain" && (
            <div>
              ...
              <input
                ...
                placeholder="e.g., cryptovault.com"
                className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-600 focus:border-green-500 focus:outline-none transition-all"
              />
            </div>
          )}
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-600 focus:border-green-500 focus:outline-none transition-all resize-none"
            />
          </div>

          <button
            type="submit"
            className="w-full py-3.5 rounded-xl bg-gradient-to-r from-green-500 to-green-600 text-white font-semibold flex items-center justify-center gap-2 hover:shadow-lg hover:shadow-green-500/20 transition-all"
          >
