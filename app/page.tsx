  ...
  const handleMainCTA = () => {
    const stored =
      typeof window !== "undefined"
        ? localStorage.getItem("coinvergence_user")
        : null;
    if (stored) {
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/[0.03] backdrop-blur-xl border border-white/5 mb-8">
              ...
              <span className="text-xs text-gray-400">
                Live Trading Active · 2,847 traders online
              </span>
            </div>
            ...
            <p className="text-lg sm:text-xl text-gray-400 max-w-2xl mx-auto mb-10 leading-relaxed">
              The safest P2P marketplace for crypto, gift cards, domains, and
              brand-ready digital assets. Buy & sell with escrow protection and
              instant settlement.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button
                onClick={handleMainCTA}
                className="bg-gradient-to-r from-violet-600 to-blue-600 text-base font-semibold px-8 py-4 rounded-2xl text-white hover:shadow-lg hover:shadow-violet-500/20 transition-all flex items-center gap-2 w-full sm:w-auto justify-center"
              >
                Start Trading Now
                <svg
                  className="w-5 h-5"
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-400">
                Four simple steps to start trading safely on Coinvergence.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Sign up in under 30 seconds. No KYC required to browse.",
                  icon: "user" as const,
                  action: () => openAuth("signup"),
                },
                {
                  num: "2",
                  title: "Browse Listings",
                  desc: "Filter by category, price, payment method, and seller rating.",
                  icon: "search" as const,
                },
                {
                  num: "3",
                  title: "Connect on WhatsApp",
                  desc: "Message verified sellers directly. Negotiate rates and terms.",
                  icon: "message" as const,
                },
                {
                  num: "4",
                  title: "Instant Settlement",
                  desc: "Confirm receipt and complete the trade. Rate your partner.",
                  icon: "zap" as const,
                },
              ].map((step) => (
                <div
                  key={step.num}
                  onClick={step.action}
                  className={`bg-white/[0.03] backdrop-blur-xl border border-white/5 rounded-2xl p-6 relative group hover:bg-white/5 transition-all ${
                    step.action ? "cursor-pointer" : ""
                  }`}
                >
                  <div className="absolute -top-3 -left-3 w-8 h-8 rounded-full bg-gradient-to-r from-violet-600 to-blue-600 flex items-center justify-center text-sm font-bold">
                    {step.num}
                  </div>
          ...
          <div className="max-w-4xl mx-auto bg-white/[0.03] backdrop-blur-xl border border-white/5 rounded-3xl p-8 sm:p-12 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-400 mb-8 max-w-xl mx-auto">
                Join thousands of traders buying and selling on the most secure
                P2P marketplace. Start trading in minutes via WhatsApp.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
                {[
                  "No fees for first 30 days",
                  "WhatsApp trading in 2 min",
